export default function EcgBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none select-none" aria-hidden="true">
      ...
      {/* Animated ECG waveform — light mode */}
      <svg
        className="absolute bottom-0 left-0 w-full opacity-[0.06] dark:hidden"
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
        >
          <animateTransform attributeName="transform" type="translate" from="100 0" to="-100 0" dur="12s" repeatCount="indefinite" />
        </path>
      </svg>

      {/* Animated ECG waveform — dark mode (lighter stroke, more visible) */}
      <svg
        className="absolute bottom-0 left-0 w-full opacity-[0.1] hidden dark:block"
        viewBox="0 0 1200 120"
        preserveAspectRatio="none"
        style={{ height: "30%" }}
      >

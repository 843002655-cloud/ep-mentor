    ...
    <AppLayout>
      <div className="max-w-xl mx-auto px-4 py-24 text-center">
        <div className="card"><div className="text-5xl mb-4">✅</div>
          <h2 className="text-2xl font-bold text-[#1A2332] dark:text-slate-100 mb-2 font-serif">提交成功</h2>
          <p className="text-[#6B7F96] dark:text-slate-400 mb-6">投稿已提交，等待管理员审核。</p>
      ...
      <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="card">
          <div className="bg-[#FEF3E2] dark:bg-amber-900/20 border border-[#854F0B]/20 dark:border-amber-500/20 rounded-lg p-4 mb-6">
            <p className="text-sm text-[#854F0B] dark:text-amber-300">📋 仅支持文字描述和心电图特征数据。请勿上传患者影像资料，去除姓名/住院号等隐私信息。</p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-4">
            {[
              ...
              <div key={f.name}>
                <label className="block text-sm font-medium text-[#3D5166] dark:text-slate-300 mb-1">{f.label} <span className="text-[#9B2C2C] dark:text-red-400">*</span></label>
            ...
            <div>
              <label className="block text-sm font-medium text-[#3D5166] dark:text-slate-300 mb-1">病例内容 <span className="text-[#9B2C2C] dark:text-red-400">*</span></label>
            ...
            {message && <div className="text-sm p-3 rounded-lg bg-[#FDE8E8] dark:bg-red-900/30 text-[#9B2C2C] dark:text-red-300 border border-[#9B2C2C]/20 dark:border-red-400/20">{message}</div>}
